...
# config = yaml.load(opt.config, Loader=yaml.FullLoader)
...
parser.add_argument("--input_mask", type=str, default=set['input_mask'])  # Phi: shift_mask   Mask: mask
...
# parser.add_argument("--config", type=list, default='config.yaml')
